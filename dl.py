...
def parse_args():
    ...
    parser.add_argument('--technology', help='specify a technology (default: react)')
    ...
    args.technology = args.technology if args.technology else None
...
class EggheadDownloader:
    def __init__(self):
        self.directory = args.directory
        self.base_url = 'https://egghead.io'
